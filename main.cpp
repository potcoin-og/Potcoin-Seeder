...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Potcoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseedz.potcoin.info", "seedeu.potcoin.info", "fast.potcoin.info", "206.223.224.225", ""};
static const string testnet_seeds[] = {"testnet.potcoin.info", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 4200), true);
  }
  do {
